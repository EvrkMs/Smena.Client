...
{
    partial class AdvanceUserControl
    {
        /// <summary> 
        ...
        {
            checkBoxExtractSalaryFromSafe = new MaterialSkin.Controls.MaterialCheckbox();
            comboBoxExtractSalaryName = new MaterialSkin.Controls.MaterialComboBox();
            buttonSendExtractSalary = new MaterialSkin.Controls.MaterialButton();
            checkBoxSalaryAdvance = new MaterialSkin.Controls.MaterialCheckbox();
            checkBoxAdvanceExtract = new MaterialSkin.Controls.MaterialCheckbox();
            textBoxSalaryExtractAmount = new MaterialSkin.Controls.MaterialTextBox();
            SuspendLayout();
            // 
            ...
            checkBoxExtractSalaryFromSafe.Location = new Point(29, 114);
            checkBoxExtractSalaryFromSafe.Margin = new Padding(0);
            checkBoxExtractSalaryFromSafe.MouseLocation = new Point(-1, -1);
            checkBoxExtractSalaryFromSafe.MouseState = MaterialSkin.MouseState.HOVER;
            ...
            checkBoxExtractSalaryFromSafe.TabIndex = 12;
            ...
            comboBoxExtractSalaryName.Location = new Point(29, 42);
            comboBoxExtractSalaryName.MaxDropDownItems = 4;
            comboBoxExtractSalaryName.MouseState = MaterialSkin.MouseState.OUT;
            ...
            comboBoxExtractSalaryName.TabIndex = 11;
            // 
            // buttonSendExtractSalary
            // 
            buttonSendExtractSalary.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            buttonSendExtractSalary.Density = MaterialSkin.Controls.MaterialButton.MaterialButtonDensity.Default;
            ...
            checkBoxSalaryAdvance.Location = new Point(460, 114);
            checkBoxSalaryAdvance.Margin = new Padding(0);
            checkBoxSalaryAdvance.MouseLocation = new Point(-1, -1);
            checkBoxSalaryAdvance.MouseState = MaterialSkin.MouseState.HOVER;
            ...
            checkBoxSalaryAdvance.TabIndex = 9;
            ...
            checkBoxAdvanceExtract.Location = new Point(358, 114);
            checkBoxAdvanceExtract.Margin = new Padding(0);
            checkBoxAdvanceExtract.MouseLocation = new Point(-1, -1);
            checkBoxAdvanceExtract.MouseState = MaterialSkin.MouseState.HOVER;
            ...
            checkBoxAdvanceExtract.TabIndex = 8;
            ...
            textBoxSalaryExtractAmount.Location = new Point(358, 41);
            textBoxSalaryExtractAmount.MaxLength = 32767;
            textBoxSalaryExtractAmount.MouseState = MaterialSkin.MouseState.OUT;
            ...
            textBoxSalaryExtractAmount.TabIndex = 7;
            ...
            Controls.Add(checkBoxExtractSalaryFromSafe);
            Controls.Add(comboBoxExtractSalaryName);
            Controls.Add(buttonSendExtractSalary);
            Controls.Add(checkBoxSalaryAdvance);
        ...
        private MaterialSkin.Controls.MaterialCheckbox checkBoxExtractSalaryFromSafe;
        private MaterialSkin.Controls.MaterialComboBox comboBoxExtractSalaryName;
        private MaterialSkin.Controls.MaterialButton buttonSendExtractSalary;
        private MaterialSkin.Controls.MaterialCheckbox checkBoxSalaryAdvance;
        private MaterialSkin.Controls.MaterialCheckbox checkBoxAdvanceExtract;
        private MaterialSkin.Controls.MaterialTextBox textBoxSalaryExtractAmount;
    }
}
